...
import { ReactComponent as Correo } from "../assets/mail.svg";
...
const Footer = () => {
    ...
    <footer>
        ...
        <div className="redes">
            ...
            <a 
              href="mailto:samuelmedina265@gmail.com"
              rel="noreferrer"
              target="_blank"
            >
...
<footer aria-label="Site Footer" classNameName="bg-white">
  <div className="max-w-screen-xl px-4 pt-8 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    
    <div
      className="pt-8 mt-16 border-t border-gray-100 sm:flex sm:items-center sm:justify-center lg:mt-24"
    >
      ...
      <ul className="flex justify-center gap-6 mt-8 sm:mt-0 lg:justify-end">
          ...
          >
            ...
            > 
              <path 
                ...
                1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 
        ...
        <li>
          <a
            href="samuelmedina265@gmail.com"
            rel="noreferrer"
            className="text-gray-700 transition hover:opacity-75"
          >
            <span className="sr-only">GitHub</span>

            <Correo className="w-6 h-6" />
          </a>
        </li>
